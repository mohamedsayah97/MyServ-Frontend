...
//                               <td className="py-3 px-4 border-b">
//                                 {cand.cv ? (
//                                   <a href={cand.cv} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
//                                     Voir CV
//                                   </a>
//                                 ) : (
...
//                               <td className="py-3 px-4 border-b">
//                                 {cand.compteRendu ? (
//                                   <a href={cand.compteRendu} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
//                                     Voir Compte Rendu
//                                   </a>
//                                 ) : (
//                                   <span className="text-gray-500">Aucun Compte Rendu</span>
//                                 )}
//                               </td>
//                            </tr>
//                          );
...
import React, { useEffect, useState } from 'react';
import { instance } from '../../config/axios';
import { FaSearch, FaSave, FaTimes, FaSpinner, FaDownload } from 'react-icons/fa';
import { Link } from 'react-router-dom';
...
const Erp = () => {
  ...
  const filteredCandidates = candidates.filter(cand => {
    const isERP = cand.Spéciality === 'Consultant SAP';
    const matchesSearch = 
      (cand.nom || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
      (cand.prenom || '').toLowerCase().includes(searchTerm.toLowerCase());
                ...
                return (
                  <tr key={cand._id} className="hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 border-b">
                      {cand.lienCV ? (
                        <button 
                          onClick={() => downloadFile(cand.lienCV, `CV_${cand.nom}_${cand.prenom}`)}
                    ...
                    <td className="py-3 px-4 border-b">
                      {cand.lien_compteRendu ? (
                        <button 
                          onClick={() => downloadFile(cand.lien_compteRendu, `CompteRendu_${cand.nom}_${cand.prenom}`)}
                          className="text-blue-500 hover:text-blue-700 flex items-center"
                        >
                          <FaDownload className="mr-1" /> Télécharger
                        </button>
