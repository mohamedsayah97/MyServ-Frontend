...
const Reseau = () => {
  ...
  const filteredCandidates = candidates.filter(candidate => {
    const fullName = `${candidate.nom.toLowerCase()} ${candidate.prenom.toLowerCase()}`;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="mb-4">
                  ...
                  <a 
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      window.open(selectedCandidate.lienCV, '_blank', 'noopener,noreferrer');
                    }}
                  >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <span>{selectedCandidate.lienCompteRendu}</span>
                    </a>
                  </div>
                </div>
              </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Réseau & Sécurité</h2>
                  ...
                  <tr className="hover:bg-gray-50 transition-colors duration-150" key={item.id}>
                    {editingId === item.id ? (
                      <>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <Link 
                            to="/dashboard/compte_rendu_reseau" 
                      ...
                      <>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <a 
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              window.open(item.lienCV, '_blank', 'noopener,noreferrer');
                            }}
                          >
                            <FaDownload className="text-blue-500" /> 
                            <span>Ouvrir CV</span>
